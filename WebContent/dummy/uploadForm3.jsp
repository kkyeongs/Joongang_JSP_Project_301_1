...
<body>
 ...
 <!-- Page Loader -->
    ...
    <!-- 이미지 업로드 부분 -->
		...
		<form class="body_window" method="post" enctype="multipart/form-data">																		<!-- <form id="contact-form" method="post" enctype="multipart/form-data"> -->
	   		 <div class="center_background">
				<!-- <div id="hidden_container"> -->
					<div class="image-upload" id="image-upload">
	
																			  <!-- <form id="contact-form" method="post" enctype="multipart/form-data"> -->																	<!-- <form method="post" enctype="multipart/form-data"> -->
						<div class="button">
							<label class="label_b" for="chooseFile">  이미지 업로드</label>
						</div>
