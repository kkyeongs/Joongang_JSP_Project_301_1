...
<!-- Page Loader -->
  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <form action="" method="post">    
        <div style="text-align: center;"><h2>ID 찾기</h2></div>
        <div style="text-align: center;"><h6>고객님의 정보와 일치하는 ID 입니다.</h6></div><br>
        <div style="text-align: center;"><h5>고객님의 ID는 <input type="text" value="${id }" > 입니다.</h5></div><br>
          	<hr>
            <div id="box1">
                <span>
                    <button class="btn btn-primary" type="button"  onclick="location.href='loginForm.do'"  style="font-size:15px; WIDTH: 100pt; HEIGHT: 25pt; padding: 0;">로그인</button>
                    <button class="btn btn-primary" type="button"  onclick="location.href='index.do'"  style="font-size:15px; WIDTH: 100pt; HEIGHT: 25pt; padding: 0;">취소</button>
