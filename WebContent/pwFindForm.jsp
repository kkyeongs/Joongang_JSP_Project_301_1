...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link nav-link-4 active" aria-current="page"
	...
	<br>
	<br>
	<form action="pwFindPro.do" method="post">
		<div style="text-align: center;">
			<h2>비밀번호 찾기</h2>
		</div>
		<br>
		<div style="justify-content: center; display: flex;">
			<input type="text" name="id" class="form-control tm-search-input"
				style="border: #00B8B8 solid 3px;" placeholder="아이디 입력"
				required="required">
		</div>
		<hr>
		<div style="justify-content: center; display: flex;">
			<input type="tel" name="phone" class="form-control tm-search-input"
				style="border: #00B8B8 solid 3px;" placeholder="전화번호 입력"
				required="required">
		</div>
		<hr>
		<div style="justify-content: center; display: flex;">
			<input type="email" name="email" class="form-control tm-search-input"
				style="border: #00B8B8 solid 3px;" placeholder="이메일 입력"
				required="required">
		</div>
		<hr>
		 ...
		 <div id="box1">
                <span>
                    <button class="btn btn-primary" type="submit"  onclick="location.href='index.do'"  style="font-size:15px; WIDTH: 100pt; HEIGHT: 25pt; padding: 0;">비밀번호 찾기</button>
